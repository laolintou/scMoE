...
hyperparameter_defaults = dict(
    ...
    dataset_name="MYE",
    do_train=True,
    load_model="../scGPT_human_HMoE_topp_test",
    mask_ratio=0.0,
    epochs=50,
    n_bins=51,
    ...
    struct=["MoE"],
    experiment="HMoE expert=12 topp=0.4 test"
)
...
for fold in range(4):
    ...
    if dataset_name == "ms":
        ...
        adata = sc.read(data_dir / f"cross_validation/fold_1/train_adata.h5ad")
        adata_val = sc.read(data_dir / f"cross_validation/fold_1/val_adata.h5ad")
        adata_test = sc.read(data_dir / f"cross_validation/fold_1/test_adata.h5ad")
